...
int main()
{
    ...
    do
    {
        ...
        printf("Apakah anda ingin memasukkan nama lagi? (y/n): ");
        scanf(" %c", &question);
    } while (tolower(question) != 'n');

    system("@cls||clear");

    printf("\n\nList Daftar Nama Mahasiswa");
    printf("\nPreorder: ");
    ...
    do
    {
        ...
        printf("\nApakah anda ingin menghapus nama lagi? (y/n): ");
        scanf(" %c", &question);
    } while (tolower(question) != 'n');

    printf("\n\nList Daftar Nama Mahasiswa Setelah Penghapusan");
    printf("\nPreorder: ");
    displayPreorder(root);
    printf("\nInorder: ");
    displayInorder(root);
